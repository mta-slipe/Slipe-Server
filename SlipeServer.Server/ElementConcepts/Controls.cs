...
/// </summary>
public class Controls(Player player)
{
    ...
    {
        player.Client.SendPacket(PlayerPacketFactory.CreateToggleAllControlsPacket(isEnabled, gtaControls, mtaControls));
        ...
        var args = new PlayerControlsChangedArgs(player, AllControls, isEnabled);
        StateChanged?.Invoke(player, args);
    }
    ...
    public bool FireEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "fire", value);
            player.Client.SendPacket(new ToggleControlAbility("fire", value));
    ...
    public bool AimWeaponEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "aim_weapon", value);
            player.Client.SendPacket(new ToggleControlAbility("aim_weapon", value));
    ...
    public bool NextWeaponEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "next_weapon", value);
            player.Client.SendPacket(new ToggleControlAbility("next_weapon", value));
    ...
    public bool PreviousWeaponEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "previous_weapon", value);
            player.Client.SendPacket(new ToggleControlAbility("previous_weapon", value));
    ...
    public bool ForwardsEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "forwards", value);
            player.Client.SendPacket(new ToggleControlAbility("forwards", value));
    ...
    public bool BackwardsEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "backwards", value);
            player.Client.SendPacket(new ToggleControlAbility("backwards", value));
    ...
    public bool LeftEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "left", value);
            player.Client.SendPacket(new ToggleControlAbility("left", value));
    ...
    public bool RightEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "right", value);
            player.Client.SendPacket(new ToggleControlAbility("right", value));
    ...
    public bool ZoomInEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "zoom_in", value);
            player.Client.SendPacket(new ToggleControlAbility("zoom_in", value));
    ...
    public bool ZoomOutEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "zoom_out", value);
            player.Client.SendPacket(new ToggleControlAbility("zoom_out", value));
    ...
    public bool ChangeCameraEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "change_camera", value);
            player.Client.SendPacket(new ToggleControlAbility("change_camera", value));
    ...
    public bool JumpEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "jump", value);
            player.Client.SendPacket(new ToggleControlAbility("jump", value));
    ...
    public bool SprintEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "sprint", value);
            player.Client.SendPacket(new ToggleControlAbility("sprint", value));
    ...
    public bool LookBehindEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "look_behind", value);
            player.Client.SendPacket(new ToggleControlAbility("look_behind", value));
    ...
    public bool CrouchEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "crouch", value);
            player.Client.SendPacket(new ToggleControlAbility("crouch", value));
    ...
    public bool ActionEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "action", value);
            player.Client.SendPacket(new ToggleControlAbility("action", value));
    ...
    public bool WalkEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "walk", value);
            player.Client.SendPacket(new ToggleControlAbility("walk", value));
    ...
    public bool ConversationYesEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "conversation_yes", value);
            player.Client.SendPacket(new ToggleControlAbility("conversation_yes", value));
    ...
    public bool ConversationNoEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "conversation_no", value);
            player.Client.SendPacket(new ToggleControlAbility("conversation_no", value));
    ...
    public bool GroupControlForwardsEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "group_control_forwards", value);
            player.Client.SendPacket(new ToggleControlAbility("group_control_forwards", value));
    ...
    public bool GroupControlBackEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "group_control_back", value);
            player.Client.SendPacket(new ToggleControlAbility("group_control_back", value));
    ...
    public bool VehicleFireEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_fire", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_fire", value));
    ...
    public bool VehicleSecondaryFireEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_secondary_fire", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_secondary_fire", value));
    ...
    public bool VehicleLeftEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_left", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_left", value));
    ...
    public bool VehicleRightEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_right", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_right", value));
    ...
    public bool SteerForwardEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "steer_forward", value);
            player.Client.SendPacket(new ToggleControlAbility("steer_forward", value));
    ...
    public bool SteerBackEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "steer_back", value);
            player.Client.SendPacket(new ToggleControlAbility("steer_back", value));
    ...
    public bool AccelerateEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "accelerate", value);
            player.Client.SendPacket(new ToggleControlAbility("accelerate", value));
    ...
    public bool BrakeReverseEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "brake_reverse", value);
            player.Client.SendPacket(new ToggleControlAbility("brake_reverse", value));
    ...
    public bool RadioNextEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radio_next", value);
            player.Client.SendPacket(new ToggleControlAbility("radio_next", value));
    ...
    public bool RadioPreviousEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radio_previous", value);
            player.Client.SendPacket(new ToggleControlAbility("radio_previous", value));
    ...
    public bool RadioUserTrackSkipEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radio_user_track_skip", value);
            player.Client.SendPacket(new ToggleControlAbility("radio_user_track_skip", value));
    ...
    public bool HornEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "horn", value);
            player.Client.SendPacket(new ToggleControlAbility("horn", value));
    ...
    public bool SubMissionEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "sub_mission", value);
            player.Client.SendPacket(new ToggleControlAbility("sub_mission", value));
    ...
    public bool HandbrakeEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "handbrake", value);
            player.Client.SendPacket(new ToggleControlAbility("handbrake", value));
    ...
    public bool VehicleLookLeftEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_look_left", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_look_left", value));
    ...
    public bool VehicleLookRightEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_look_right", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_look_right", value));
    ...
    public bool VehicleLookBehindEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_look_behind", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_look_behind", value));
    ...
    public bool VehicleMouseLookEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "vehicle_mouse_look", value);
            player.Client.SendPacket(new ToggleControlAbility("vehicle_mouse_look", value));
    ...
    public bool SpecialControlLeftEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "special_control_left", value);
            player.Client.SendPacket(new ToggleControlAbility("special_control_left", value));
    ...
    public bool SpecialControlRightEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "special_control_right", value);
            player.Client.SendPacket(new ToggleControlAbility("special_control_right", value));
    ...
    public bool SpecialControlDownEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "special_control_down", value);
            player.Client.SendPacket(new ToggleControlAbility("special_control_down", value));
    ...
    public bool SpecialControlUpEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "special_control_up", value);
            player.Client.SendPacket(new ToggleControlAbility("special_control_up", value));
    ...
    public bool EnterExitEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "enter_exit", value);
            player.Client.SendPacket(new ToggleControlAbility("enter_exit", value));
    ...
    public bool EnterPassengerEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "enter_passenger", value);
            player.Client.SendPacket(new ToggleControlAbility("enter_passenger", value));
    ...
    public bool ScreenshotEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "screenshot", value);
            player.Client.SendPacket(new ToggleControlAbility("screenshot", value));
    ...
    public bool ChatboxEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "chatbox", value);
            player.Client.SendPacket(new ToggleControlAbility("chatbox", value));
    ...
    public bool RadarEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar", value);
            player.Client.SendPacket(new ToggleControlAbility("radar", value));
    ...
    public bool RadarZoomInEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_zoom_in", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_zoom_in", value));
    ...
    public bool RadarZoomOutEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_zoom_out", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_zoom_out", value));
    ...
    public bool RadarMoveNorthEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_move_north", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_move_north", value));
    ...
    public bool RadarMoveSouthEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_move_south", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_move_south", value));
    ...
    public bool RadarMoveEastEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_move_east", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_move_east", value));
    ...
    public bool RadarMoveWestEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_move_west", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_move_west", value));
    ...
    public bool RadarAttachEnabled
    {
        ...
        set
        {
            var args = new PlayerControlsChangedArgs(player, "radar_attach", value);
            player.Client.SendPacket(new ToggleControlAbility("radar_attach", value));
