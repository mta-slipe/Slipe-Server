...
public class VehicleConstants
{
    ...
    {
        [VehicleModel.Landstalker] = VehicleType.Autmobile,
        [VehicleModel.Bravura] = VehicleType.Autmobile,
        [VehicleModel.Buffalo] = VehicleType.Autmobile,
        [VehicleModel.Linerunner] = VehicleType.Autmobile,
        [VehicleModel.Perennial] = VehicleType.Autmobile,
        [VehicleModel.Sentinel] = VehicleType.Autmobile,
        [VehicleModel.Dumper] = VehicleType.MonsterTruck,
        [VehicleModel.FireTruck] = VehicleType.Autmobile,
        [VehicleModel.Trashmaster] = VehicleType.Autmobile,
        [VehicleModel.Stretch] = VehicleType.Autmobile,
        [VehicleModel.Manana] = VehicleType.Autmobile,
        [VehicleModel.Infernus] = VehicleType.Autmobile,
        [VehicleModel.Voodoo] = VehicleType.Autmobile,
        [VehicleModel.Pony] = VehicleType.Autmobile,
        [VehicleModel.Mule] = VehicleType.Autmobile,
        [VehicleModel.Cheetah] = VehicleType.Autmobile,
        [VehicleModel.Ambulance] = VehicleType.Autmobile,
        [VehicleModel.Leviathan] = VehicleType.Helicopter,
        [VehicleModel.Moonbeam] = VehicleType.Autmobile,
        [VehicleModel.Esperanto] = VehicleType.Autmobile,
        [VehicleModel.Taxi] = VehicleType.Autmobile,
        [VehicleModel.Washington] = VehicleType.Autmobile,
        [VehicleModel.Bobcat] = VehicleType.Autmobile,
        [VehicleModel.MrWhoopee] = VehicleType.Autmobile,
        [VehicleModel.BFInjection] = VehicleType.Autmobile,
        [VehicleModel.Hunter] = VehicleType.Helicopter,
        [VehicleModel.Premier] = VehicleType.Autmobile,
        [VehicleModel.Enforcer] = VehicleType.Autmobile,
        [VehicleModel.Securicar] = VehicleType.Autmobile,
        [VehicleModel.Banshee] = VehicleType.Autmobile,
        [VehicleModel.Predator] = VehicleType.Boat,
        [VehicleModel.Bus] = VehicleType.Autmobile,
        [VehicleModel.Rhino] = VehicleType.Autmobile,
        [VehicleModel.Barracks] = VehicleType.Autmobile,
        [VehicleModel.Hotknife] = VehicleType.Autmobile,
        [VehicleModel.Trailer1] = VehicleType.Trailer,
        [VehicleModel.Previon] = VehicleType.Autmobile,
        [VehicleModel.Coach] = VehicleType.Autmobile,
        [VehicleModel.Cabbie] = VehicleType.Autmobile,
        [VehicleModel.Stallion] = VehicleType.Autmobile,
        [VehicleModel.Rumpo] = VehicleType.Autmobile,
        [VehicleModel.RCBandit] = VehicleType.Autmobile,
        [VehicleModel.Romero] = VehicleType.Autmobile,
        [VehicleModel.Packer] = VehicleType.Autmobile,
        [VehicleModel.Monster] = VehicleType.MonsterTruck,
        [VehicleModel.Admiral] = VehicleType.Autmobile,
        ...
        [VehicleModel.Turismo] = VehicleType.Autmobile,
        [VehicleModel.Speeder] = VehicleType.Boat,
        [VehicleModel.Reefer] = VehicleType.Boat,
        [VehicleModel.Tropic] = VehicleType.Boat,
        [VehicleModel.Flatbed] = VehicleType.Autmobile,
        [VehicleModel.Yankee] = VehicleType.Autmobile,
        [VehicleModel.Caddy] = VehicleType.Autmobile,
        [VehicleModel.Solair] = VehicleType.Autmobile,
        [VehicleModel.BerkleysRCVan] = VehicleType.Autmobile,
        ...
        [VehicleModel.Glendale] = VehicleType.Autmobile,
        [VehicleModel.Oceanic] = VehicleType.Autmobile,
        [VehicleModel.Sanchez] = VehicleType.Motorcycle,
        [VehicleModel.Sparrow] = VehicleType.Helicopter,
        [VehicleModel.Patriot] = VehicleType.Autmobile,
        [VehicleModel.Quadbike] = VehicleType.QuadBike,
        [VehicleModel.Coastguard] = VehicleType.Boat,
        [VehicleModel.Dinghy] = VehicleType.Boat,
        [VehicleModel.Hermes] = VehicleType.Autmobile,
        [VehicleModel.Sabre] = VehicleType.Autmobile,
        [VehicleModel.Rustler] = VehicleType.Plane,
        [VehicleModel.ZR350] = VehicleType.Autmobile,
        [VehicleModel.Walton] = VehicleType.Autmobile,
        [VehicleModel.Regina] = VehicleType.Autmobile,
        [VehicleModel.Comet] = VehicleType.Autmobile,
        [VehicleModel.BMX] = VehicleType.Bmx,
        [VehicleModel.Burrito] = VehicleType.Autmobile,
        [VehicleModel.Camper] = VehicleType.Autmobile,
        [VehicleModel.Marquis] = VehicleType.Boat,
        [VehicleModel.Baggage] = VehicleType.Autmobile,
        [VehicleModel.Dozer] = VehicleType.Autmobile,
        [VehicleModel.Maverick] = VehicleType.Helicopter,
        [VehicleModel.NewsChopper] = VehicleType.Helicopter,
        [VehicleModel.Rancher] = VehicleType.Autmobile,
        [VehicleModel.FBIRancher] = VehicleType.Autmobile,
        [VehicleModel.Virgo] = VehicleType.Autmobile,
        [VehicleModel.Greenwood] = VehicleType.Autmobile,
        [VehicleModel.Jetmax] = VehicleType.Boat,
        [VehicleModel.HotringRacer] = VehicleType.Autmobile,
        [VehicleModel.Sandking] = VehicleType.Autmobile,
        [VehicleModel.BlistaCompact] = VehicleType.Autmobile,
        [VehicleModel.PoliceMaverick] = VehicleType.Helicopter,
        [VehicleModel.Boxville] = VehicleType.Autmobile,
        [VehicleModel.Benson] = VehicleType.Autmobile,
        [VehicleModel.Mesa] = VehicleType.Autmobile,
        [VehicleModel.RCGoblin] = VehicleType.Helicopter,
        [VehicleModel.HotringRacer3] = VehicleType.Autmobile,
        [VehicleModel.HotringRacer2] = VehicleType.Autmobile,
        [VehicleModel.BloodringBanger] = VehicleType.Autmobile,
        [VehicleModel.RancherLure] = VehicleType.Autmobile,
        [VehicleModel.SuperGT] = VehicleType.Autmobile,
        [VehicleModel.Elegant] = VehicleType.Autmobile,
        [VehicleModel.Journey] = VehicleType.Autmobile,
        ...
        [VehicleModel.Tanker] = VehicleType.Autmobile,
        [VehicleModel.Roadtrain] = VehicleType.Autmobile,
        [VehicleModel.Nebula] = VehicleType.Autmobile,
        [VehicleModel.Majestic] = VehicleType.Autmobile,
        [VehicleModel.Buccaneer] = VehicleType.Autmobile,
        ...
        [VehicleModel.CementTruck] = VehicleType.Autmobile,
        [VehicleModel.Towtruck] = VehicleType.Autmobile,
        [VehicleModel.Fortune] = VehicleType.Autmobile,
        [VehicleModel.Cadrona] = VehicleType.Autmobile,
        [VehicleModel.FBITruck] = VehicleType.Autmobile,
        [VehicleModel.Willard] = VehicleType.Autmobile,
        [VehicleModel.Forklift] = VehicleType.Autmobile,
        [VehicleModel.Tractor] = VehicleType.Autmobile,
        [VehicleModel.CombineHarvester] = VehicleType.Autmobile,
        [VehicleModel.Feltzer] = VehicleType.Autmobile,
        [VehicleModel.Remington] = VehicleType.Autmobile,
        [VehicleModel.Slamvan] = VehicleType.Autmobile,
        [VehicleModel.Blade] = VehicleType.Autmobile,
        [VehicleModel.Freight] = VehicleType.Train,
        [VehicleModel.Streak] = VehicleType.Train,
        [VehicleModel.Vortex] = VehicleType.Plane,
        [VehicleModel.Vincent] = VehicleType.Autmobile,
        [VehicleModel.Bullet] = VehicleType.Autmobile,
        [VehicleModel.Clover] = VehicleType.Autmobile,
        [VehicleModel.Sadler] = VehicleType.Autmobile,
        [VehicleModel.FireTruckLadder] = VehicleType.Autmobile,
        [VehicleModel.Hustler] = VehicleType.Autmobile,
        [VehicleModel.Intruder] = VehicleType.Autmobile,
        [VehicleModel.Primo] = VehicleType.Autmobile,
        [VehicleModel.Cargobob] = VehicleType.Helicopter,
        [VehicleModel.Tampa] = VehicleType.Autmobile,
        [VehicleModel.Sunrise] = VehicleType.Autmobile,
        [VehicleModel.Merit] = VehicleType.Autmobile,
        [VehicleModel.UtilityVan] = VehicleType.Autmobile,
        [VehicleModel.Nevada] = VehicleType.Plane,
        [VehicleModel.Yosemite] = VehicleType.Autmobile,
        [VehicleModel.Windsor] = VehicleType.Autmobile,
        [VehicleModel.Monster2] = VehicleType.MonsterTruck,
        [VehicleModel.Monster3] = VehicleType.MonsterTruck,
        [VehicleModel.Uranus] = VehicleType.Autmobile,
        [VehicleModel.Jester] = VehicleType.Autmobile,
        [VehicleModel.Sultan] = VehicleType.Autmobile,
        [VehicleModel.Stratum] = VehicleType.Autmobile,
        [VehicleModel.Elegy] = VehicleType.Autmobile,
        [VehicleModel.Raindance] = VehicleType.Helicopter,
        [VehicleModel.RCTiger] = VehicleType.Autmobile,
        [VehicleModel.Flash] = VehicleType.Autmobile,
        [VehicleModel.Tahoma] = VehicleType.Autmobile,
        [VehicleModel.Savanna] = VehicleType.Autmobile,
        [VehicleModel.Bandito] = VehicleType.Autmobile,
        [VehicleModel.FreightTrainFlatbed] = VehicleType.Train,
        [VehicleModel.StreakTrainTrailer] = VehicleType.Train,
        [VehicleModel.Kart] = VehicleType.Autmobile,
        [VehicleModel.Mower] = VehicleType.Autmobile,
        [VehicleModel.Dune] = VehicleType.MonsterTruck,
        [VehicleModel.Sweeper] = VehicleType.Autmobile,
        [VehicleModel.Broadway] = VehicleType.Autmobile,
        [VehicleModel.Tornado] = VehicleType.Autmobile,
        [VehicleModel.AT400] = VehicleType.Plane,
        [VehicleModel.DFT30] = VehicleType.Autmobile,
        [VehicleModel.Huntley] = VehicleType.Autmobile,
        [VehicleModel.Stafford] = VehicleType.Autmobile,
        [VehicleModel.BF400] = VehicleType.Motorcycle,
        [VehicleModel.Newsvan] = VehicleType.Autmobile,
        [VehicleModel.Tug] = VehicleType.Autmobile,
        [VehicleModel.TrailerTankerCommando] = VehicleType.Trailer,
        [VehicleModel.Emperor] = VehicleType.Autmobile,
        [VehicleModel.Wayfarer] = VehicleType.Motorcycle,
        [VehicleModel.Euros] = VehicleType.Autmobile,
        [VehicleModel.Hotdog] = VehicleType.Autmobile,
        [VehicleModel.Club] = VehicleType.Autmobile,
        ...
        [VehicleModel.RCCam] = VehicleType.Autmobile,
        [VehicleModel.Launch] = VehicleType.Boat,
        [VehicleModel.PoliceLS] = VehicleType.Autmobile,
        [VehicleModel.PoliceSf] = VehicleType.Autmobile,
        [VehicleModel.PoliceLV] = VehicleType.Autmobile,
        [VehicleModel.PoliceRanger] = VehicleType.Autmobile,
        [VehicleModel.Picador] = VehicleType.Autmobile,
        [VehicleModel.SwatTank] = VehicleType.Autmobile,
        [VehicleModel.Alpha] = VehicleType.Autmobile,
        [VehicleModel.Phoenix] = VehicleType.Autmobile,
        [VehicleModel.GlendaleDamaged] = VehicleType.Autmobile,
        [VehicleModel.SadlerDamaged] = VehicleType.Autmobile,
