...
public class SpatialHashCompoundElementCollection() : IElementCollection
{
    public int Count => this.flatElementCollection.Count;

    private readonly FlatElementCollection flatElementCollection = new();
    private readonly ElementByIdCollection elementByIdCollection = new();
    private readonly ElementByTypeCollection elementByTypeCollection = new();
