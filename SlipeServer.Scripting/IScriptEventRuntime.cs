...
namespace SlipeServer.Scripting
{
    ...
    public delegate EventHandlerActions<T> EventRegistrationDelegate<T>(Element element, ScriptCallbackDelegateWrapper<ScriptCallbackDelegate> callback) where T : Element;
