...
System.namespace("SlipeLua.Shared.Helpers", function (namespace)
  ...
  namespace.class("EasingFunction", function (namespace)
    ...
    __ctor2__ = function (this, function_, period, amplitude, overshoot)
      setName(this, getName(function_))
      setPeriod(this, period)
      setAmplitude(this, amplitude)
      setOvershoot(this, overshoot)
    end
    ...
    Interpolate = function (this, progress)
      return SlipeLuaMtaDefinitions.MtaShared.GetEasingValue(progress, getName(this), getPeriod(this), getAmplitude(this), getOvershoot(this))
    end
    InterpolateVector = function (this, start, end_, progress)
      local r = SlipeLuaMtaDefinitions.MtaShared.InterpolateBetween(start.X, start.Y, start.Z, end_.X, end_.Y, end_.Z, progress, getName(this), getPeriod(this), getAmplitude(this), getOvershoot(this))
