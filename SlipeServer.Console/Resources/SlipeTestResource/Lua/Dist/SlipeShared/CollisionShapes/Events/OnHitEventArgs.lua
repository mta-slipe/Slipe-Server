...
System.namespace("SlipeLua.Shared.CollisionShapes.Events", function (namespace)
  namespace.class("OnHitEventArgs", function (namespace)
    ...
    __ctor__ = function (this, element, matchingDimension)
      setElement(this, SlipeLuaSharedElements.ElementManager.getInstance():GetElement(element, SlipeLuaSharedElements.PhysicalElement))
