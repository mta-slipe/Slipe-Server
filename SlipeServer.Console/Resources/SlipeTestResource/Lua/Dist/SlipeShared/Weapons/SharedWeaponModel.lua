...
System.namespace("SlipeLua.Shared.Weapons", function (namespace)
  ...
  namespace.class("SharedWeaponModel", function (namespace)
    ...
    getName = function (this)
      return SlipeLuaMtaDefinitions.MtaShared.GetWeaponNameFromID(getID(this))
    end
    getSlot = function (this)
      return SlipeLuaMtaDefinitions.MtaShared.GetSlotFromWeapon(getID(this))
    end
    getFist = function ()
      return class(0)
    end
    ...
    GetOriginalProperty = function (this, skill, property)
      return SlipeLuaMtaDefinitions.MtaShared.GetOriginalWeaponProperty(getID(this), skill:EnumToString(SlipeLuaSharedWeapons.WeaponSkill):ToLower(), property:EnumToString(SlipeLuaSharedWeapons.WeaponProperty):ToLower())
    end
    GetProperty = function (this, skill, property)
      return SlipeLuaMtaDefinitions.MtaShared.GetWeaponProperty(getID(this), skill:EnumToString(SlipeLuaSharedWeapons.WeaponSkill):ToLower(), property:EnumToString(SlipeLuaSharedWeapons.WeaponProperty):ToLower())
    end
    class = {
      ID = 0,
      getID = getID,
