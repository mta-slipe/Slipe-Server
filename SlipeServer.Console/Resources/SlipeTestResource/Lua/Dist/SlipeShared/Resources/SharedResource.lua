...
System.namespace("SlipeLua.Shared.Resources", function (namespace)
  ...
  namespace.class("SharedResource", function (namespace)
    ...
    getName = function (this)
      return SlipeLuaMtaDefinitions.MtaShared.GetResourceName(getMtaResource(this))
    end
    getDynamicRoot = function (this)
      return SlipeLuaSharedElements.ElementManager.getInstance():GetElement1(SlipeLuaMtaDefinitions.MtaShared.GetResourceDynamicElementRoot(getMtaResource(this)))
    end
    getRoot = function (this)
      return SlipeLuaSharedElements.ElementManager.getInstance():GetElement1(SlipeLuaMtaDefinitions.MtaShared.GetResourceRootElement(getMtaResource(this)))
    end
    getState = function (this)
      return SlipeLuaMtaDefinitions.MtaShared.GetResourceState(getMtaResource(this))
    end
    getExportedFunctions = function (this)
      return SlipeLuaMtaDefinitions.MtaShared.GetArrayFromTable(SlipeLuaMtaDefinitions.MtaShared.GetResourceExportedFunctions(getMtaResource(this)), "System.String", T)
    end
