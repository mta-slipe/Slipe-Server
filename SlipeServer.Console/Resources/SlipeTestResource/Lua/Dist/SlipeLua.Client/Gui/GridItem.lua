...
System.namespace("SlipeLua.Client.Gui", function (namespace)
  ...
  namespace.class("GridItem", function (namespace)
    ...
    getColor = function (this)
      local color = SlipeLuaMtaDefinitions.MtaClient.GuiGridListGetItemColor(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID())
    ...
    setColor = function (this, value)
      SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetItemColor(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID(), value:getR(), value:getG(), value:getB(), value:getA())
    end
    getContent = function (this)
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListGetItemText(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID())
    end
    setContent = function (this, value)
      SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetItemText(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID(), value, false, false)
    end
    getData = function (this)
      if System.String.IsNullOrEmpty(getContent(this)) then
        setContent(this, "")
      end
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListGetItemData(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID())
    end
    setData = function (this, value)
      if System.String.IsNullOrEmpty(getContent(this)) then
        setContent(this, "")
      end
      SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetItemData(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID(), value)
    end
    SetSection = function (this, content)
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetItemText(this.glist:getMTAElement(), this.Row:getID(), this.Column:getID(), content, true, false)
    end
    return {
      getColumn = getColumn,
      getRow = getRow,
