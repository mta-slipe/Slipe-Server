...
System.namespace("SlipeLua.Client.Lights", function (namespace)
  ...
  namespace.class("SearchLight", function (namespace)
    ...
    Update = function (this, source, eventArgs)
      setStartPosition(this, SystemNumerics.Vector3.op_Addition(getToAttached(this):getPosition(), getOffset(this):getTranslation()))
      setEndPosition(this, SystemNumerics.Vector3.Transform(this.relativeEndPosition, SystemNumerics.Matrix4x4.op_Multiply(getToAttached(this):getMatrix(), getOffset(this))))
    end
    return {
      base = function (out)
        return {
