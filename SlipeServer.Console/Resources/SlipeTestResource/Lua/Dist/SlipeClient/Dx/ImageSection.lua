...
System.namespace("SlipeLua.Client.Dx", function (namespace)
  ...
  namespace.class("ImageSection", function (namespace)
    ...
    __ctor1__ = function (this, position, dimensions, sectionUV, UVDimensions, filePath, rotation, rotationCenter, color, postGUI)
      ...
      setSectionTopLeft(this, sectionUV:__clone__())
      setSectionDimensions(this, UVDimensions:__clone__())
    end
    ...
    Draw = function (this, source, eventArgs)
      if this.usePath then
        return SlipeLuaMtaDefinitions.MtaClient.DxDrawImageSection(this:getPosition().X, this:getPosition().Y, this:getDimensions().X, this:getDimensions().Y, getSectionTopLeft(this).X, getSectionTopLeft(this).Y, getSectionDimensions(this).X, getSectionDimensions(this).Y, this:getFilePath(), this:getRotation(), this:getRotationCenter().X, this:getRotationCenter().Y, this:getColor():getHex(), this:getPostGUI())
      else
        local default = this:getMaterial()
        if default ~= nil then
          default = default:getMaterialElement()
        end
        return SlipeLuaMtaDefinitions.MtaClient.DxDrawImageSection(this:getPosition().X, this:getPosition().Y, this:getDimensions().X, this:getDimensions().Y, getSectionTopLeft(this).X, getSectionTopLeft(this).Y, getSectionDimensions(this).X, getSectionDimensions(this).Y, default, this:getRotation(), this:getRotationCenter().X, this:getRotationCenter().Y, this:getColor():getHex(), this:getPostGUI())
      end
    end
    return {
      base = function (out)
