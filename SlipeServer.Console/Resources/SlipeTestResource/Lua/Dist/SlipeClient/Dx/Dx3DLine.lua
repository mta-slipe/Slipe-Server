  ...
  namespace.class("Dx3DLine", function (namespace)
    ...
    Draw = function (this, source, eventArgs)
      if getVisible(this) then
        return SlipeLuaMtaDefinitions.MtaClient.DxDrawLine3D(getStartPosition(this).X, getStartPosition(this).Y, getStartPosition(this).Z, getEndPosition(this).X, getEndPosition(this).Y, getEndPosition(this).Z, getColor(this):getHex(), getWidth(this), getPostGUI(this))
      end
      return false
    end
    Update = function (this, source, eventArgs)
      if this:getIsAttached() then
        this.startPos = SystemNumerics.Vector3.op_Addition(this:getToAttached():getPosition(), this:getOffset():getTranslation())
        this.endPos = SystemNumerics.Vector3.Transform(this.relativeEndPosition, SystemNumerics.Matrix4x4.op_Multiply(this:getToAttached():getMatrix(), this:getOffset()))
      end
    end
    return {
      base = function (out)
