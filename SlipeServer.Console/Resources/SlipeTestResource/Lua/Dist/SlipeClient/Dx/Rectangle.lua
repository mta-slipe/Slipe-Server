...
System.namespace("SlipeLua.Client.Dx", function (namespace)
  ...
  namespace.class("Rectangle", function (namespace)
    ...
    Draw = function (this, source, eventArgs)
      return SlipeLuaMtaDefinitions.MtaClient.DxDrawRectangle(this:getPosition().X, this:getPosition().Y, getDimensions(this).X, getDimensions(this).Y, this:getColor():getHex(), this:getPostGUI(), getSubPixelPositioning(this))
    end
    return {
      base = function (out)
        return {
