  ...
  namespace.class("Dx2DObject", function (namespace)
    ...
    Update = function (this, source, eventArgs)
      if this:getIsAttached() then
        this.pos = SlipeLuaClientRendering.Renderer.ScreenFromWorldPosition(SystemNumerics.Vector3.op_Addition(this:getToAttached():getPosition(), this:getOffset():getTranslation()), 0, true)
      end
    end
    return {
      base = function (out)
