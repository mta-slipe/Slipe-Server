...
System.namespace("SlipeLua.Client.Sounds", function (namespace)
  ...
  namespace.class("Sound", function (namespace)
    ...
    __ctor4__ = function (this, station, trackId, looped)
      __ctor1__(this, SlipeLuaMtaDefinitions.MtaClient.PlaySFX1("radio", SlipeLuaMtaDefinitions.MtaClient.GetRadioChannelName(station), trackId, looped))
    end
    __ctor5__ = function (this, station, trackId, looped)
      __ctor1__(this, SlipeLuaMtaDefinitions.MtaClient.PlaySFX1("radio", station:EnumToString(SlipeLuaClientSounds.ExtraStations), trackId, looped))
    end
