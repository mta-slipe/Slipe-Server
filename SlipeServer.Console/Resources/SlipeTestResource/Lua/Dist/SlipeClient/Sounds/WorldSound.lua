...
System.namespace("SlipeLua.Client.Sounds", function (namespace)
  ...
  namespace.class("WorldSound", function (namespace)
    ...
    __ctor4__ = function (this, station, trackId, position, looped)
      __ctor1__(this, SlipeLuaMtaDefinitions.MtaClient.PlaySFX3D1("radio", SlipeLuaMtaDefinitions.MtaClient.GetRadioChannelName(station), trackId, position.X, position.Y, position.Z, looped))
    end
    __ctor5__ = function (this, station, trackId, position, looped)
      __ctor1__(this, SlipeLuaMtaDefinitions.MtaClient.PlaySFX3D1("radio", station:EnumToString(SlipeLuaClientSounds.ExtraStations), trackId, position.X, position.Y, position.Z, looped))
    end
    ...
    Detach = function (this)
      SlipeLuaMtaDefinitions.MtaShared.DetachElements(this.element)
    end
