...
System.namespace("SlipeLua.Client.SightLines", function (namespace)
  ...
  namespace.class("SightLineData", function (namespace)
    ...
    __ctor__ = function (this, d)
      ...
      setDidHit(this, d[1])
      if getDidHit(this) then
        setCollisionPosition(this, SystemNumerics.Vector3(d[2], d[3], d[4]))
        if d[5] ~= nil then
          setHitElement(this, SlipeLuaSharedElements.ElementManager.getInstance():GetElement(d[5], SlipeLuaSharedElements.PhysicalElement))
        end
        setNormal(this, SystemNumerics.Vector3(d[6], d[7], d:getRest()[1]))
        setSurfaceMaterial(this, d:getRest()[2])
        setLighting(this, d:getRest()[3])
        this.piece = d:getRest()[4]

        if d:getRest()[5] ~= nil then
          setWorldModelID(this, System.Nullable.Value(d:getRest()[5]))
          setWorldModelMatrix(this, SystemNumerics.Matrix4x4.op_Addition(SystemNumerics.Matrix4x4.CreateTranslation(d:getRest()[6], d:getRest()[7], d:getRest():getRest()[1]), SystemNumerics.Matrix4x4.CreateFromQuaternion(SlipeLuaSharedHelpers.NumericHelper.EulerToQuaternion(SystemNumerics.Vector3(d:getRest():getRest()[2], d:getRest():getRest()[3], d:getRest():getRest()[4])))))
          setWorldLODModelID(this, d:getRest():getRest()[5])
        end
      end
    end
