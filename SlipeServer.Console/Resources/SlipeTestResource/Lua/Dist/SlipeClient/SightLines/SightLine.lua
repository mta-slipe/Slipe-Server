...
System.namespace("SlipeLua.Client.SightLines", function (namespace)
  ...
  namespace.class("SightLine", function (namespace)
    ...
    __ctor1__ = function (this, startPos, endPos, checkBuildings, checkVehicles, checkPeds, checkWorldObjects, seeThroughStuff, ignoreSomeObjectsForCamera, shootThroughStuff, includeWorldModelInformation, includeCarTyreHits, ignoredElement)
      ...
      setCheckBuildings(this, checkBuildings)
      setCheckVehicles(this, checkVehicles)
      setCheckPeds(this, checkPeds)
      setCheckWorldObjects(this, checkWorldObjects)
      setSeeThroughStuff(this, seeThroughStuff)
      setIgnoreSomeObjectsForCamera(this, ignoreSomeObjectsForCamera)
      setShootThroughStuff(this, shootThroughStuff)
      setIncludeWorldModelInformation(this, includeWorldModelInformation)
      setIncludeCarTyreHits(this, includeCarTyreHits)
      setIgnoredElement(this, ignoredElement)
    end
    ...
    getData = function (this)
      local default = getIgnoredElement(this)
      if default ~= nil then
        default = default:getMTAElement()
      end
      return SlipeLuaClientSightLines.SightLineData(SlipeLuaMtaDefinitions.MtaClient.ProcessLineOfSight(this:getStartPosition().X, this:getStartPosition().Y, this:getStartPosition().Z, this:getEndPosition().X, this:getEndPosition().Y, this:getEndPosition().Z, getCheckBuildings(this), getCheckVehicles(this), getCheckPeds(this), getCheckWorldObjects(this), false, getSeeThroughStuff(this), getIgnoreSomeObjectsForCamera(this), getShootThroughStuff(this), default, getIncludeWorldModelInformation(this), getIncludeCarTyreHits(this)))
    end
