...
System.namespace("SlipeLua.Client.Vehicles.Events", function (namespace)
  namespace.class("OnCollisionEventArgs", function (namespace)
    ...
    __ctor__ = function (this, hitElement, force, bodyPart, cx, cy, cz, nx, ny, nz, model)
      ...
      setElement(this, SlipeLuaSharedElements.ElementManager.getInstance():GetElement(hitElement, SlipeLuaSharedElements.PhysicalElement))
      setForce(this, System.cast(System.Single, force))
      setPart(this, System.cast(System.Int32, bodyPart))
      setPosition(this, SystemNumerics.Vector3(System.cast(System.Single, cx), System.cast(System.Single, cy), System.cast(System.Single, cz)))
      ...
      setModel(this, System.cast(System.Int32, model))
    end
