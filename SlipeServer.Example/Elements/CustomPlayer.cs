...
public class CustomPlayer : Player
{
    ...
    public CustomPlayer(ExplosionService explosionService, MtaServer server) : base()
    {
        ...
        var color = GetColor();
        this.Blip = CreateBlipFor(BlipIcon.Marker, color: color).AssociateWith(server);
    ...
    private async void HandleWasted(Ped sender, Server.Elements.Events.PedWastedEventArgs e)
    {
        ...
        Spawn(new Vector3(0, 0, 3), 0, 7, 0, 0);
    }
    ...
    {
        TriggerLuaEvent("Slipe.Test.RequestCursor", parameters: isShowing);
    }
