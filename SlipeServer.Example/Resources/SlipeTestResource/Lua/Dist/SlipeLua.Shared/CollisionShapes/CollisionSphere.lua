...
System.namespace("SlipeLua.Shared.CollisionShapes", function (namespace)
  ...
  namespace.class("CollisionSphere", function (namespace)
    ...
    __ctor2__ = function (this, position, radius)
      __ctor1__(this, SlipeLuaMtaDefinitions.MtaShared.CreateColSphere(position.X, position.Y, position.Z, radius))
    end
    return {
      base = function (out)
        return {
      ...
      __metadata__ = function (out)
        return {
          methods = {
            ...
            { ".ctor", 0x206, __ctor2__, System.Numerics.Vector3, System.Single }
          },
          class = { 0x6 }
        }
      end
