...
System.namespace("SlipeLua.Client.Peds.Events", function (namespace)
  namespace.class("OnChokeEventArgs", function (namespace)
    ...
    __ctor__ = function (this, model, ped)
      this.WeaponModel = SlipeLuaSharedWeapons.SharedWeaponModel(System.cast(System.Int32, model))
      this.ResponsiblePed = SlipeLuaSharedElements.ElementManager.getInstance():GetElement(ped, SlipeLuaClientPeds.Ped)
    end
