...
System.namespace("SlipeLua.Client.Gui", function (namespace)
  ...
  namespace.class("GridColumn", function (namespace)
    ...
    __ctor__ = function (this, title, width, gridList)
      this.ID = SlipeLuaMtaDefinitions.MtaClient.GuiGridListAddColumn(gridList:getMTAElement(), title, width)
      this.glist = gridList
    end
    getID = System.property("ID", true)
    getTitle = function (this)
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListGetColumnTitle(this.glist:getMTAElement(), this.ID)
    end
    setTitle = function (this, value)
      SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetColumnTitle(this.glist:getMTAElement(), this.ID, value)
    end
    getAbsoluteWidth = function (this)
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListGetColumnWidth(this.glist:getMTAElement(), this.ID, false)
    end
    setAbsoluteWidth = function (this, value)
      SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetColumnWidth(this.glist:getMTAElement(), this.ID, value, false)
    end
    getRelativeWidth = function (this)
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListGetColumnWidth(this.glist:getMTAElement(), this.ID, true)
    end
    setRelativeWidth = function (this, value)
      SlipeLuaMtaDefinitions.MtaClient.GuiGridListSetColumnWidth(this.glist:getMTAElement(), this.ID, value, true)
    end
    AutoSize = function (this)
      return SlipeLuaMtaDefinitions.MtaClient.GuiGridListAutoSizeColumn(this.glist:getMTAElement(), this.ID)
    end
    return {
      ID = 0,
      getID = getID,
